...
contract testEVVMFuzz_caPay is Test {
    SMateMock sMate;
    EvvmMock evvm;
     ...
     */
    function test__fuzz__caPay__noSMate(uint256 amountToSend) external {
        ...
        evvm.caPay(USER3, ETHER_ADDRESS, amountToSend);
    ...
    function test__fuzz__caPay__SMate(uint256 amountToSend) external {
        amountToSend = bound(amountToSend, 0, 99 * 10 ** 30);
