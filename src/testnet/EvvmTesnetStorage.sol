...
import {EvvmTesnetStructs} from "./EvvmTesnetStructs.sol";

/**
 * @title EvvmTesnetStorage
 * @author jistro.eth
 * @dev Storage layout contract for EVVM proxy pattern implementation.
 *      This contract inherits all structures from EvvmTesnetStructs and
...
abstract contract EvvmTesnetStorage is EvvmTesnetStructs {
